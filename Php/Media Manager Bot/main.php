<?php
    ...
    if(in_array($user_id, $admin)) {
        ...
        if($text == "/start") {
            if($f[$chat_id]["Add Media"] == 1 or $f[$chat_id]["Delete Media"] == 1 or $f[$chat_id]["Broadcast"] == 1 or $f[$chat_id]["Rename Caption"] == 1 or $f[$chat_id]["Set Default Caption"] == 1 or $f[$chat_id]["Unban User"] == 1 or $f[$chat_id]["Ban User"] == 1) {
